// Checks content against a real swiftc through the site's own runtime: every playground runs cleanly,
// every starter compiles but fails its tests, and with --solutions <dir> every <id>.<n>.swift passes.
// npm run verify [-- src/content/optionals.md ...] [-- --solutions ../solutions]
