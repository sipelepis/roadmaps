// Checks content against the live Rust Playground through the site's own runtime: every playground runs
// cleanly, every starter compiles but fails its tests, and with --solutions <dir> every <id>.<n>.rs passes.
// npm run verify [-- src/content/maps.md ...] [-- --solutions ../solutions]
import { readFileSync, readdirSync, existsSync } from 'node:fs'
import { marked, type Token, type Tokens } from 'marked'
import { run, type RunResult } from './src/runtime.ts'

const LANG = 'rust', EXT = 'rs'
