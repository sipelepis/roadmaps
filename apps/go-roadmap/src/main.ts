...
function shell(active: string, body: string, side = '') {
  ...
  app.innerHTML = `${SPRITE}
    <header class="nav">
      <a class="brand" href="#/" aria-label="Go Roadmap home"><span class="mark">GO</span><span class="brand-name">Roadmap</span></a>
...
function home() {
  ...
  shell('home', `
    <section class="hero">
      <h1>Learn <em>Go</em> the way it fits together.</h1>
      <p class="lead">${nodes.length} modules laid out by what they build on, each with an article, a live playground, and exercises with tests you solve right here in the browser. Real Go, compiled by the official Go Playground. No install.</p>
      <div class="actions">
...
const STAGES: Record<number, string> = { 0: 'Foundations', 1: 'Foundations', 2: 'Foundations', 3: 'Core language', 4: 'Core language', 5: 'Types and packages', 6: 'Types and packages', 7: 'Idiomatic Go', 8: 'Idiomatic Go', 9: 'In practice' }
