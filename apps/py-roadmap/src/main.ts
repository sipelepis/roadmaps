...
function home() {
  ...
  shell('home', `
    <section class="hero">
      <h1>Learn <em>Python</em> the way it fits together.</h1>
      <p class="lead">${nodes.length} modules laid out by what they build on, each with an article, a live playground, and exercises with tests you solve right here in the browser. Real Python, no install.</p>
      <div class="actions">
...
const STAGES: Record<number, string> = { 0: 'Foundations', 1: 'Foundations', 2: 'Core language', 3: 'Core language', 4: 'Structure', 5: 'Structure', 6: 'Idiomatic Python', 7: 'Idiomatic Python', 8: 'In practice' }
