...
function shell(active: string, body: string, side = '') {
  ...
  app.innerHTML = `${SPRITE}
    <header class="nav">
      <a class="brand" href="#/" aria-label="Kotlin Roadmap home"><span class="mark">KT</span><span class="brand-name">Roadmap</span></a>
...
function home() {
  ...
  shell('home', `
    <section class="hero">
      <h1>Learn <em>Kotlin</em> the way it fits together.</h1>
      <p class="lead">${nodes.length} modules laid out by what they build on, each with an article, a live playground, and exercises with tests you solve right here in the browser. Real Kotlin, compiled by the official Kotlin Playground. No install.</p>
      <div class="actions">
...
const STAGES: Record<number, string> = { 0: 'Foundations', 1: 'Foundations', 2: 'Foundations', 3: 'Core language', 4: 'Core language', 5: 'Data and collections', 6: 'Data and collections', 7: 'Idiomatic Kotlin', 8: 'Idiomatic Kotlin', 9: 'Generics and concurrency', 10: 'Generics and concurrency', 11: 'In practice' }
